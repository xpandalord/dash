...
@app.callback(
    ...
    [
        Input("blueTowersDestroyed", "value"),
        Input("blueTotalGold", "value"),
        Input("blueKills", "value"),
        Input("redKills", "value"),
        Input("redTotalGold", "value"),
        Input("redTowersDestroyed", "value"),
    ],
)
def predict(
    blueTowersDestroyed,
