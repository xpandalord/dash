...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            we can just focus on the amount of gold each team has.

            The amount of gold can determine whether the team has the economy to buy items that will influece
            the outcome of the game. Furthermore, there are so many insights we can gather from the factors that
            lead to a gold advantage.
            ...
            Kills will also set the enemy team back since while they are dead, your own team can continue to accumlate resources/
            ...
            and every other resource is the key to victory.
